...
export const API_ENDPOINT = 'https://api.nytimes.com';
export const ARTICLES_PATH = 'svc/search/v2/articlesearch.json?fl=_id,headline,lead_paragraph,document_type,web_url,pub_date';
